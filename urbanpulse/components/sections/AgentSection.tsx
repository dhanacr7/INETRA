      ...
      <PageContainer>
        <div className="agent-header">
          <SectionHeader
            ...
            description="INETRA behaves as an intelligent operational system, not a passive dashboard. Specialized agents coordinate to discover, corroborate, reconstruct and verify."
          />
        </div>
